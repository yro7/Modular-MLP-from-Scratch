...
public class LayerMatrix {
    ...
    /**
     * Le biais de chaque neurone. Si la couche possède n neurone, la {@link Matrices.Matrix} {@link BiasVector} sera de dimension n*1.
     */
     ...
     */
    public LayerMatrix(int numberOfNeurons, int numberOfNeuronsOfPreviousLayer, ActivationFunction activationFunction){
     ...
     */
    public ActivationMatrix computeActivationMatrixOfPreviousLayer(ActivationMatrix activationsOfPreviousLayer) {
        ActivationMatrix newActivationMatrix = new ActivationMatrix(0,0/**TODO insérer bonnes dimensions**/);

        return (ActivationMatrix) activationsOfPreviousLayer.clone()
                .multiply(this.weightMatrix);
    }
