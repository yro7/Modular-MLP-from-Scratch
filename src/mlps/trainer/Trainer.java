...
import static mlps.data.Loaders.Dataloader.LabeledBatch;
...
public class Trainer {
    ...
    public void train(MLP mlp) {
        ...
        for(int i = 0; i < this.numberOfEpochs(); i++) {
            ...
            for(int j = 0; j < this.getTrainingData().getNumberOfBatches(); j++) {
                ...
                if(verbose) {
                  ...
                  //  System.out.print("  "); evaluation.print();
                    ...
                    // évolution de la loss sur le batch fait uniquement et pas tout le
                    // test set (temporaire) TODO change
                    if(j % 5 == 0) {
                        double loss = mlp.computeLoss(batch.getInput(), batch.getOutput(), this.getLossFunction());
                        System.out.println("Loss sur cette batch : " + loss);
                    }
                }
            }
            ...
            evaluation.print();
            System.out.println();
            System.out.println("Temps d'entraînement : " +
                    (timeEndTraining-timeStartTraining)/1000 + " secondes.");
    }
